    ...
    <section class="px-8 py-12">
        ...
        <div class="flex space-x-6 overflow-x-auto pb-4 scrollbar-hide">
            @foreach($sub_category as $c)
                <a href="/subcategory/{{ encrypt($c->id) }}" 
                   class="min-w-[250px] bg-white shadow-md rounded-2xl overflow-hidden transform hover:scale-105 transition duration-300 block">
                    ...
                    <div class="p-4">
                        <h4 class="font-semibold text-lg text-gray-800">{{ $c->sub_category }}</h4>
                        <p class="text-sm text-gray-500 mt-1">Explore our {{ strtolower($c->sub_category) }} collection</p>
